  ...
  shared_examples 'trove authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_trove_config('keystone_authtoken/auth_url').with_value('http://localhost:5000')
        ...
        is_expected.to contain_trove_config('keystone_authtoken/service_token_roles').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_trove_config('keystone_authtoken/service_token_roles_required').with_value('<SERVICE DEFAULT>')
      end
    end
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_trove_config('keystone_authtoken/service_token_roles').with_value(params[:service_token_roles])
        is_expected.to contain_trove_config('keystone_authtoken/service_token_roles_required').with_value(params[:service_token_roles_required])
      end
