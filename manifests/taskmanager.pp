...
the future release. Please use trove::default_neutron_networks instead.")
    $default_neutron_networks_real = $default_neutron_networks
  } else {
    $default_neutron_networks_real = $::trove::default_neutron_networks
  }

  if $taskmanager_queue {
    warning("trove::taskmanager::taskmanager_queue is deprecated and will be removed in \
the future release. Please use trove::taskmanager_queue instead.")
    trove_config {
